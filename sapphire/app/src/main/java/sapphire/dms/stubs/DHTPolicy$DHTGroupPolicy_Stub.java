/*
 * Stub for class sapphire.dms.dht.DHTPolicy.DHTGroupPolicy
...
public final class DHTPolicy$DHTGroupPolicy_Stub extends sapphire.dms.dht.DHTPolicy.DHTGroupPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public sapphire.dms.SapphirePolicy.SapphireServerPolicy onRefRequest() {
        ...
        String $__method = "public sapphire.dms.SapphirePolicy$SapphireServerPolicy sapphire.dms.dht.DHTPolicy$DHTGroupPolicy.onRefRequest()";
    ...
    public void onFailure(sapphire.dms.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.dht.DHTPolicy$DHTGroupPolicy.onFailure(sapphire.dms.SapphirePolicy$SapphireServerPolicy)";
    ...
    public void onCreate(sapphire.dms.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.dht.DHTPolicy$DHTGroupPolicy.onCreate(sapphire.dms.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public java.util.ArrayList getServers() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.util.ArrayList<sapphire.dms.SapphirePolicy$SapphireServerPolicy> sapphire.dms.dht.DHTPolicy$DHTGroupPolicy.getServers()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public sapphire.dms.dht.DHTPolicy.DHTServerPolicy dhtGetResponsibleNode(sapphire.dms.interfaces.dht.DHTKey $param_DHTKey_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.dms.dht.DHTPolicy$DHTServerPolicy sapphire.dms.dht.DHTPolicy$DHTGroupPolicy.dhtGetResponsibleNode(sapphire.dms.interfaces.dht.DHTKey)";
    ...
    public void addServer(sapphire.dms.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.dht.DHTPolicy$DHTGroupPolicy.addServer(sapphire.dms.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
