/*
 * Stub for class sapphire.dms.servercache.DurableOnDemandCachedList.DurableOnDemandCachedListServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.dms.stubs;


public final class DurableOnDemandCachedList$DurableOnDemandCachedListServerPolicy_Stub extends sapphire.dms.servercache.DurableOnDemandCachedList.DurableOnDemandCachedListServerPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public java.lang.Object onRPC(java.lang.String $param_String_1, java.util.ArrayList $param_ArrayList_2)
        ...
        String $__method = "public java.lang.Object sapphire.dms.servercache.DurableOnDemandCachedList$DurableOnDemandCachedListServerPolicy.onRPC(java.lang.String,java.util.ArrayList<java.lang.Object>) throws java.lang.Exception";
    ...
    public void onMembershipChange() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.servercache.DurableOnDemandCachedList$DurableOnDemandCachedListServerPolicy.onMembershipChange()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void onCreate(sapphire.dms.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.servercache.DurableOnDemandCachedList$DurableOnDemandCachedListServerPolicy.onCreate(sapphire.dms.SapphirePolicy$SapphireGroupPolicy)";
    ...
    public sapphire.dms.SapphirePolicy.SapphireGroupPolicy getGroup() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.dms.SapphirePolicy$SapphireGroupPolicy sapphire.dms.servercache.DurableOnDemandCachedList$DurableOnDemandCachedListServerPolicy.getGroup()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
