/*
 * Stub for class sapphire.dms.cache.CacheLeasePolicy.CacheLeaseServerPolicy
...
public final class CacheLeasePolicy$CacheLeaseServerPolicy_Stub extends sapphire.dms.cache.CacheLeasePolicy.CacheLeaseServerPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public void syncObject(java.lang.Integer $param_Integer_1, java.io.Serializable $param_Serializable_2) {
        ...
        String $__method = "public void sapphire.dms.cache.CacheLeasePolicy$CacheLeaseServerPolicy.syncObject(java.lang.Integer,java.io.Serializable)";
    ...
    public void onMembershipChange() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.cache.CacheLeasePolicy$CacheLeaseServerPolicy.onMembershipChange()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void onCreate(sapphire.dms.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.cache.CacheLeasePolicy$CacheLeaseServerPolicy.onCreate(sapphire.dms.SapphirePolicy$SapphireGroupPolicy)";
    ...
    public sapphire.dms.cache.CacheLeasePolicy.CacheLease getLease(java.lang.Integer $param_Integer_1)
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.dms.cache.CacheLeasePolicy$CacheLease sapphire.dms.cache.CacheLeasePolicy$CacheLeaseServerPolicy.getLease(java.lang.Integer) throws java.lang.Exception";
        $__params.add($param_Integer_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        ...
        return ((sapphire.dms.cache.CacheLeasePolicy.CacheLease) $__result);
    }

    // Implementation of getLease()
    public sapphire.dms.cache.CacheLeasePolicy.CacheLease getLease()
            throws java.lang.Exception {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.dms.cache.CacheLeasePolicy$CacheLease sapphire.dms.cache.CacheLeasePolicy$CacheLeaseServerPolicy.getLease() throws java.lang.Exception";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public sapphire.dms.SapphirePolicy.SapphireGroupPolicy getGroup() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.dms.SapphirePolicy$SapphireGroupPolicy sapphire.dms.cache.CacheLeasePolicy$CacheLeaseServerPolicy.getGroup()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
