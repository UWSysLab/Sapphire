/*
 * Stub for class sapphire.dms.cache.CacheLeasePolicy.CacheLeaseGroupPolicy
...
public final class CacheLeasePolicy$CacheLeaseGroupPolicy_Stub extends sapphire.dms.cache.CacheLeasePolicy.CacheLeaseGroupPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public sapphire.dms.SapphirePolicy.SapphireServerPolicy onRefRequest() {
        ...
        String $__method = "public sapphire.dms.SapphirePolicy$SapphireServerPolicy sapphire.dms.cache.CacheLeasePolicy$CacheLeaseGroupPolicy.onRefRequest()";
    ...
    public void onFailure(sapphire.dms.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.cache.CacheLeasePolicy$CacheLeaseGroupPolicy.onFailure(sapphire.dms.SapphirePolicy$SapphireServerPolicy)";
    ...
    public void onCreate(sapphire.dms.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.cache.CacheLeasePolicy$CacheLeaseGroupPolicy.onCreate(sapphire.dms.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public java.util.ArrayList getServers() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public java.util.ArrayList<sapphire.dms.SapphirePolicy$SapphireServerPolicy> sapphire.dms.cache.CacheLeasePolicy$CacheLeaseGroupPolicy.getServers()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
    ...
    public void addServer(sapphire.dms.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public void sapphire.dms.cache.CacheLeasePolicy$CacheLeaseGroupPolicy.addServer(sapphire.dms.SapphirePolicy$SapphireServerPolicy)";
        $__params.add($param_SapphirePolicy$SapphireServerPolicy_1);
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
